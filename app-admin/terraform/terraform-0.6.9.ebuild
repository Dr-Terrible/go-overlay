...
GOLANG_PKG_DEPENDENCIES=(
	...
	"github.com/hashicorp/go-retryablehttp:24fda80"
	...
	"github.com/lusis/go-artifactory:11648ae"
	"github.com/sthulb/mime:698462d"
	...
	"github.com/xanzy/ssh-agent:ba9c9e3"
	"github.com/hmrc/vmware-govcd:8d41785"
	"github.com/lib/pq:11fc39a"
	"github.com/ziutek/mymysql:75ce5fb"
	"github.com/go-chef/chef:ea19666"

	# Unit Testing
	"github.com/armon/circbuf:bbbad09"
	"github.com/Azure/azure-sdk-for-go:01f39a2"
	...
	"github.com/xanzy/go-cloudstack:eaf4e42"
...
COMMON_IUSE="chef"
IUSE_PROVIDERS="atlas aws azure azurerm cloudflare cloudstack consul digitalocean dme dnsimple docker dyn google heroku mailgun +null openstack packet rundeck statuscake +template +tls vsphere vcd postgresql mysql"
