...
GOLANG_PKG_DEPENDENCIES=(
	...
	"github.com/codegangsta/cli:1efa31f"
	...
	"github.com/go-sql-driver/mysql:3654d25"
	"github.com/go-xorm/core:bc1b7f8"
	"github.com/go-xorm/xorm:b8b1711"
	"github.com/gogits/chardet:2404f77"
	"github.com/gogits/go-gogs-client:ee68cd9"
	"github.com/gogits/cron:96040e4"
	"github.com/gogits/git-module:53bcb73"
	"github.com/issue9/identicon:d36b545"
	"github.com/jaytaylor/html2text:52d9b78"
	"github.com/klauspost/compress:14eb9c4"
	"github.com/klauspost/cpuid:09cded8"
	"github.com/klauspost/crc32:19b0b33"
	"github.com/lib/pq:ee1442b"
	"github.com/mattn/go-sqlite3:38ee283"
	...
	"github.com/russross/blackfriday:4e6f303"
	"github.com/shurcooL/sanitized_anchor_name:10ef21a"
	"github.com/satori/go.uuid:879c588"
	"github.com/sergi/go-diff:ec7fdbb"
	"github.com/golang/net:3f122ce -> golang.org/x"
	"github.com/golang/sys:7f918dd -> golang.org/x"
	"github.com/golang/text:e477511 -> golang.org/x"
	"github.com/go-gomail/gomail:81ebce5 -> gopkg.in/gomail.v2"
	"github.com/go-ini/ini:72ba3e6 -> gopkg.in/ini.v1"
	"github.com/go-macaron/macaron:2133042 -> gopkg.in/macaron.v1"
	"github.com/go-redis/redis:e617904 -> gopkg.in/redis.v2" #v2.3.2
	"github.com/go-bufio/bufio:567b2bf -> gopkg.in/bufio.v1"
	"github.com/go-ldap/ldap:0e7db8e -> gopkg.in/ldap.v2" #v2.3.0
	...
	# Unit testing
	"github.com/golang/crypto:77f4136 -> golang.org/x"
