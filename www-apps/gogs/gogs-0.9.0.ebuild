...
GOLANG_PKG_DEPENDENCIES=(
	...
	"github.com/codegangsta/cli:a294348"
	"github.com/go-macaron/binding:a68f342"
	"github.com/go-macaron/cache:5617353"
	"github.com/go-macaron/captcha:8aa5919"
	"github.com/go-macaron/csrf:546646c"
	...
	"github.com/go-sql-driver/mysql:0f2db9e"
	"github.com/go-xorm/core:5021584"
	"github.com/go-xorm/xorm:1045aa0"
	"github.com/gogits/chardet:2404f77"
	"github.com/gogits/go-gogs-client:d584b1e"
	"github.com/gogits/cron:3abc0f8"
	"github.com/gogits/git-module:76e8cce"
	"github.com/issue9/identicon:f8c0d2c"
	"github.com/klauspost/compress:2d3d403"
	"github.com/klauspost/cpuid:09cded8"
	"github.com/klauspost/crc32:19b0b33"
	"github.com/lib/pq:165a352"
	"github.com/mattn/go-sqlite3:45f056c"
	...
	"github.com/satori/go.uuid:e673fdd"
	"github.com/sergi/go-diff:ec7fdbb"
	"github.com/golang/net:a4bbce9 -> golang.org/x"
	"github.com/golang/text:a71fd10 -> golang.org/x"
	"github.com/go-gomail/gomail:5ceb8e6 -> gopkg.in/gomail.v2"
	"github.com/go-ini/ini:776aa73 -> gopkg.in/ini.v1"
	"github.com/go-macaron/macaron:b9eee38 -> gopkg.in/macaron.v1"
	"github.com/go-redis/redis:e617904 -> gopkg.in/redis.v2" #v2.3.2
	"github.com/go-bufio/bufio:567b2bf -> gopkg.in/bufio.v1"
	"github.com/go-ldap/ldap:07a7330 -> gopkg.in/ldap.v2" #v2.2
	...
	# Unit testing
	"github.com/golang/crypto:5dc8cb4 -> golang.org/x"
