...
GOLANG_PKG_DEPENDENCIES=(
	...
	"github.com/Unknwon/i18n:7457d88"
	"github.com/Unknwon/paginater:7748a72"
	"github.com/codegangsta/cli:0302d39"
	...
	"github.com/go-macaron/i18n:5e728b6"
	"github.com/go-macaron/inject:c5ab7bf"
	"github.com/go-macaron/session:66031fc"
	"github.com/go-macaron/toolbox:ab30a81"
	"github.com/go-sql-driver/mysql:a732e14" #v1.2
	"github.com/go-xorm/core:3e10003"
	"github.com/go-xorm/xorm:c643188"
	"github.com/gogits/chardet:2404f77"
	"github.com/gogits/go-gogs-client:7c02c95"
	"github.com/issue9/identicon:f8c0d2c"
	"github.com/klauspost/compress:782cf19"
	"github.com/klauspost/cpuid:8d9fe96"
	"github.com/klauspost/crc32:3e5c38b"
	"github.com/lib/pq:11fc39a"
	"github.com/mattn/go-sqlite3:3b3f1d0" #v1.1.0
	"github.com/mcuadros/go-version:d52711f"
	"github.com/microcosm-cc/bluemonday:4ac6f27"
	"github.com/msteinert/pam:6534f23"
	"github.com/nfnt/resize:dc93e1b"
	"github.com/russross/blackfriday:0b647d0" #v1.4
	"github.com/shurcooL/sanitized_anchor_name:10ef21a "
	"github.com/golang/net:62ac18b -> golang.org/x"
	"github.com/golang/text:e684700 -> golang.org/x"
	"github.com/go-gomail/gomail:df6fc79 -> gopkg.in/gomail.v2"
	"github.com/go-ini/ini:03e0e7d -> gopkg.in/ini.v1"
	"github.com/go-macaron/macaron:1c6dd87 -> gopkg.in/macaron.v1"
	...
	# Unit testing
	"github.com/golang/crypto:beef0f4 -> golang.org/x"
