...
GOLANG_PKG_DEPENDENCIES=(
	...
	"github.com/go-sql-driver/mysql:a0583e0"
	"github.com/go-xorm/builder:db75972"
	"github.com/go-xorm/core:87aca22"
	"github.com/go-xorm/xorm:3ad0b42"
	...
	"github.com/jaytaylor/html2text:4b9124c"
	"github.com/klauspost/compress:e3b7981"
	"github.com/klauspost/cpuid:09cded8"
	"github.com/klauspost/crc32:cb6bfca"
	"github.com/lib/pq:5bf1611"
	"github.com/mattn/go-sqlite3:2d44dec"
	...
	"github.com/sergi/go-diff:83532ca"
	...
	"github.com/go-ini/ini:6f66b0e -> gopkg.in/ini.v1"
	"github.com/go-macaron/macaron:ddb19a9 -> gopkg.in/macaron.v1"
	"github.com/go-redis/redis:e617904 -> gopkg.in/redis.v2" #v2.3.2
	"github.com/go-bufio/bufio:567b2bf -> gopkg.in/bufio.v1"
	"github.com/go-ldap/ldap:8168ee0 -> gopkg.in/ldap.v2" #v2.3.0
